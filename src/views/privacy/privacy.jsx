    ...
    <div>
        ...
        <div id="content">
            ...
            <p className="summary">
                ...
                we keep it safe. It also tells you about the choices and options you have about your
                information.
            </p>
            <p>
                The Scratch Foundation, and associated entities (collectively, "
                <strong>Scratch</strong>", "<strong>we</strong>", "<strong>our</strong>" or "
            ...
            <p>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Consent.</strong> We may use your Personal Information when you have
                        consented to do so.
                    </li>
                </ul>
            </p>
            ...
            <p>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Education and research institutions.</strong> We may share the
                        results of our research on children's education through ScratchJr, in a
                        de-identified and aggregate form, with educators and research institutions,
                        such as Tufts University and MIT, through conferences, journals, and other
                        publications.
                    </li>
                    <li>
            ...
            <p className="summary">
                If you are in the EEA, the UK or Switzerland, you and your parents have the right
                to:
                <ul>
                    <li>Be told how we use your information.</li>
                    <li>Ask to see the information we have about you.</li>
                    <li>Ask us to change information you think is wrong.</li>
                    <li>Ask us to remove information when it's not needed anymore.</li>
                    <li>Ask us to only use your information in certain ways.</li>
                    <li>Tell us you don't want your information to be processed.</li>
                    <li>
                        If the information we are collecting is information that you can choose not
                        to give, you can tell us to stop collecting it at any time.
                    </li>
                </ul>
                If you're interested in how we get and use your information, you can contact us in
                any of the ways explained below under "Contact Us" or speak to your parents, who
                will be able to help you and answer any questions that you have. If you are in the
                EEA, the UK or Switzerland, you may also submit a complaint with the relevant
                authority.
            </p>
            <p>
            ...
            <p>
                ...
                that is the case. For more information on your rights, or to submit a request to
                exercise your rights under applicable law, please contact us as indicated in the
                'Contact Us' section below.
            </p>
            <h2>Data Retention</h2>
            <p className="summary">
                We don't keep your information forever. We only keep it for as long as we need it to
            ...
            <p>
                ...
                account various criteria, such as the type of services requested by or provided to
                you, the nature and length of our relationship with you, possible re-enrollment with
                our services, the impact on the services we provide to you if we delete some
            ...
            <p>
                ...
                intended to protect the information we collect on the App against accidental or
                ...
                Personal Information in our possession. However, as effective as these measures are,
                no security system is impenetrable. We cannot completely guarantee the security of
            ...
            <p>
                ...
                appropriate. If we make material changes, we will notify you thereof. We encourage
                you to review our Privacy Policy on a regular basis. The “Last Updated” date at the
                top of this page indicates when this Privacy Policy was last revised. Your continued
                use of the App following these changes means that you accept the revised Privacy
                Policy.
            </p>
            <h2>International Cross-Border Data Transfer</h2>
            <p className="summary">
                Your information will be stored and used by Scratch in the United States, where the
                laws and protections of your information may be different than in your country. We
...
render(<Privacy />, document.getElementById('app'));
