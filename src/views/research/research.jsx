...
const Research = () => (
    <div>
        ...
        <div id="content">
            <div className="content-section" id="research-section">
                ...
                <div className="content-section-description">
                    ...
                    how programming supports their overall development. 
                    Since its launch, the DevTech Research Group has {' '}
                            <a href="https://sites.bc.edu/devtech/research/scratchjr-around-the-world-2/">
                                studied ScratchJr’s 
                    global impact
                            </a>, {' '} using their findings to create evidence-based curricula and 
                    assessments.
                ...
                <div className="content-description-answer">
                            {/*
                                Drop the five images into static/images/research/ using the
                                filenames below (recommended size ~360x360 to match the home page
                                stat images), or swap the src/alt values for your own assets.
                            */}
                ...
                <div id="content-description">
                    ...
                    <div className="content-description-section">
                        ...
                        <div className="content-description-answer">
                            The DevTech Research Group has developed assessments to help measure how children learn with
                            ScratchJr. Explore the{' '}
                    ...
                    <div className="content-description-section">
                        ...
                        <div className="content-description-answer">
                            The DevTech Research Group has shared ScratchJr research through conferences, journals, and other
                            publications. See {' '}
