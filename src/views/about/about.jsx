...
var About = React.createClass({
  ...
  componentDidMount: function() {
    $(function() {
      ...
      var hash = location.hash.substr(1) || 'info';

      if (hash){
        if ($('#'+hash+'-section').length) {
          updateContent(hash+'-section');
          updateCategory(hash+'-section');
        } else {
          updateContent(hash);
          var category = $(".read-more#"+hash).closest($(".content-section")).attr('id');
    ...
    function updateContent(hash) {
      if($(".content-section#"+hash).length)  {
        console.log(hash);
        $('.content-section').removeClass('content-section-selected');
        $(".content-section#"+hash).addClass('content-section-selected');
        console.log($(".content-section#"+hash));
      }
    }

    function updateCategory(hash) {
      if($(".content-nav-item#"+hash).length)  {
        $('.content-nav-item').removeClass('content-nav-item-selected');
        $(".content-nav-item#"+hash).addClass('content-nav-item-selected');
      }
	...
	render: function() {
      ...
      <div>
        ...
        <div id="content">
          ...
          <div id="content-nav">
            <a href="#info">
              <div className="content-nav-item content-nav-item-selected content-nav-item-left" id="info-section">
          <div className="content-nav-item-icon info-icon"> </div>
          <div className="content-nav-item-description">
            ...
            <a href="#press">
              <div className="content-nav-item content-nav-item-middle" id="press-section">
          <div className="content-nav-item-icon press-icon"> </div>
                <div className="content-nav-item-description">
                  Press
                </div>
              </div>
            ...
            <a href="#faq">
              <div className="content-nav-item content-nav-item-middle" id="faq-section">
          <div className="content-nav-item-icon faq-icon"> </div>
                <div className="content-nav-item-description">
                  FAQ
                </div>
              </div>
            ...
            <a href="#videos">
              <div className="content-nav-item content-nav-item-right" id="videos-section">
          <div className="content-nav-item-icon videos-icon"> </div>
                <div className="content-nav-item-description">
          Videos
          </div>
              </div>
          ...
          {/* Start of Info About Page */}
          <div className="content-section content-section-selected" id="info-section">
          ...
          <div id="video-wrapper">
            <iframe src="http://player.vimeo.com/video/101760650?portrait=0&amp;byline=0&amp;title=0" width="640" height="360" frameborder="0"webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
          </div>
          <div id="content-description">
            <div className="content-description-section">
              <div className="content-description-question">What is ScratchJr?</div>

              <div className="content-description-answer"> ScratchJr is an introductory programming language that enables young children (ages 5-7) to create their own interactive stories and games. Children snap together graphical programming blocks to make characters move, jump, dance, and sing. Children can modify characters in the paint editor, add their own voices and sounds, even insert photos of themselves -- then use the programming blocks to make their characters come to life.</div>

              <div className="content-description-answer"> ScratchJr was inspired by the popular Scratch programming language (<a href="http://scratch.mit.edu">http://scratch.mit.edu</a>), used by millions of young people (ages 8 and up) around the world. In creating ScratchJr, we  redesigned the interface and programming language to make them developmentally appropriate for younger children, carefully designing features to match young children's cognitive, personal, social, and emotional development.</div>

              <div className="content-description-answer">ScratchJr is available as a free app for both iPad and Android tablets. For more information about ScratchJr, see http://scratchjr.org. </div>
            </div>

            <div className="content-description-section">
              <div className="content-description-question">Why Did We Create ScratchJr?</div>

              <div className="content-description-answer">Coding (or computer programming) is a new type of literacy. Just as writing helps you organize your thinking and express your ideas, the same is true for coding. In the past, coding was seen as too difficult for most people. But we think coding should be for everyone, just like writing.</div>

              <div className="content-description-answer">As young children code with ScratchJr, they learn how to create and express themselves with the computer, not just to interact with it. In the process, children learn to solve problems and design projects, and they develop sequencing skills that are foundational for later academic success. They also use math and language in a meaningful and motivating context, supporting the development of early-childhood numeracy and literacy. With ScratchJr, children aren't just learning to code, they are coding to learn.</div>
            </div>

            <div className="content-description-section">
              <div className="content-description-question">Who Created ScratchJr?</div>

              <div className="content-description-answer"> ScratchJr is a collaboration between the <a href="http://ase.tufts.edu/devtech/">Developmental Technologies (DevTech) Research Group</a> at the <a href="http://ase.tufts.edu/epcshd/"> Eliot-Pearson Department of Child Study and Human Development</a> at <a href="http://www.tufts.edu/">Tufts University</a> (led by <a href="http://www.tufts.edu/~mbers01/">Marina Umaschi Bers</a>, with contributions from Amanda Strawhacker, Claire Caine, Louise Flannery, Elizabeth Kazakoff and Dylan Portelance), the <a href="http://llk.media.mit.edu/">Lifelong Kindergarten</a> group at the <a href="http://www.media.mit.edu/">MIT Media Lab</a> (led by <a href="http://web.media.mit.edu/~mres/">Mitchel Resnick</a>, with contributions from Chris Garrity, Tim Mickel, Carl Bowman, Champika Fernando, Natalie Rusk, Sayamindu Dasgupta, and Chris Graves), and the <a href="http://www.playfulinvention.com/">Playful Invention Company</a> (led by Paula Bont&aacute; and Brian Silverman, with contributions from Jack Geddes and Adrian Gabriel). The Android version of ScratchJr was implemented by <a href="http://www.twosigma.com/">Two Sigma</a> (led by Mark Roth, with contributions from Kevin Hu), with input from Benesse Corp.</div>

              <div className="content-description-answer"> The graphics and illustrations for ScratchJr were created by <a href="http://www.hvingtquatre.com/">HvingtQuatre Company</a> (led by Julien Gelifier and Adrien Valesa), <a href="http://sarahjt.com/">Sarah Thomson</a>, Peter Mueller, and Jillian Lombardi. Paula Aguilera of the MIT Media Lab produced the ScratchJr video. We would also like to thank everyone who participated in the beta-test communities for iPad and Android, particularly Sergio Antolinez, Vandendaele Didier, and Sjoerd Dirk Meijer.
              </div>
            </div>
          ...
          {/* End of Press About Page */}

          {/* Start of FAQ About Page */}
          <div className="content-section content-section-selected" id="faq-section">
            <div className="content-section-title">
            ...
            <div className="content-description-section">
              ...
              <div className="content-description-answer">ScratchJr runs on both iPads and Android tablets. It will run on any iPad 2 or later, including all iPad minis, with iOS 7.0 or later installed. It also runs on any Android tablet, 7-inches or larger, that are running Android 4.2 (Jelly Bean MR1) or higher. It does not need web-access to run.</div>
            </div>
            ...
            <div className="content-description-section">
              ...
              <div className="content-description-answer">In March 2016 a version was released for Chromebooks. You can find <a href="https://chrome.google.com/webstore/detail/scratchjr/oipimoeophamdcmjcfameoojlbhbgjda">ScratchJr</a> in the <a href="https://chrome.google.com/webstore/detail/scratchjr/oipimoeophamdcmjcfameoojlbhbgjda">Chrome Web Store</a>.<br />
              This version was built from the Android version. We have had to remove some features, such as sharing, due to differences between Android and Chrome OS. We are providing this application <b>AS IS</b>. If you run into problems, please do let us know, but we cannot promise that we will fix bugs in this version.</div>
            </div>

            <div className="content-description-section">
              <div className="content-description-question">Are you planning to release a Web version of ScratchJr?</div>

              <div className="content-description-answer">We are still in the early planning stages for a Web version.</div>
            </div>

            <div className="content-description-section">
              <div className="content-description-question">I have an Android tablet that is running 4.2+, but Google Play still says that my device is incompatible.</div>

              <div className="content-description-answer">
                If Google Play doesn't recognize your tablet as meeting the minimum requirements of ScratchJr, it will not allow it to be installed. If you believe that your tablet does meet the minimum requirements (7-inch tablet) running Android 4.2 or greater, and you are willing to side-load the apk, you can download and install a copy of the <a href="http://scratch-downloads.s3.amazonaws.com/jr/ScratchJr-1.1.apk">current version of ScratchJr APK</a>. <br /><br />
            ...
            <div className="content-description-section">
              <div className="content-description-question">Can I share a ScratchJr project from one tablet to another?</div>
            ...
            <div className="content-description-section">
              <div className="content-description-question">Why can't ScratchJr record a sound or take a picture</div>

              <div className="content-description-answer">If ScratchJr can't record sounds or take a picture with the camera, it might be that you didn't give ScratchJr access to the camera or microphone when you first downloaded the app. You can change this by going to <em>Settings > Privacy > Camera</em> on your device. If the ScratchJr toggle is off, turn it on. Do the same for the microphone, under <em>Settings > Privacy > Microphone</em></div>
            </div>

            <div className="content-description-section">
              <div className="content-description-question">Will ScratchJr be available in other languages?</div>

              <div className="content-description-answer">
                The next version of ScratchJr will support Spanish, and we hope to include translation to other languages in future versions of ScratchJr. If you're interested in volunteering to help with translations, please email <a href="mailto:info@scratchjr.org">info@scratchjr.org</a> with your name and the language you can help with.
              </div>
            </div>
          ...
          {/* End of FAQ About Page */}

          {/* Start of Videos About Page */}
          <div className="content-section content-section-selected" id="videos-section">
            <div className="content-section-title">
             Videos
            </div>
            <div className="content-section-description">
        ...
        <div id="footer">
          ...
          <div className="footer-links"><a href="privacy.html">Privacy Policy</a></div>
        </div> {/* end footer */}
      </div>
		);
	}
