...
assert.ok(
    snippets.every(s => s.priority === '100'),
    'generated snippets use the default snippet priority'
);
assert.ok(
    snippets.every(s => s.content.startsWith('# Generated by bin/configure-fastly.js')),
    'every generated snippet carries a provenance header'
);
